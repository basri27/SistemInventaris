...
@section('title', 'Profil - Sistem Inventaris | PT. SCCI')
@section('page-path', 'Profil')
@section('page-title', 'Profil')
@section('content')

    <div>
        <div class="container-fluid">
            <div class="page-header min-height-300 border-radius-xl mt-4" background-position-y: 50%;">
                            ...
                            <ul class="nav nav-pills nav-fill p-1 bg-transparent" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link mb-0 px-0 py-1 active " data-bs-toggle="tab"
                                        data-bs-target="#profile" href="javascript;" role="tab" aria-controls="overview"
                                        aria-selected="true">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link mb-0 px-0 py-1 " data-bs-toggle="tab" data-bs-target="#password"
                                        href="javascript;" role="tab" aria-controls="dashboard" aria-selected="false">
        ...
        <div class="container-fluid py-4 tab-content">
            <div class="card tab-pane show fade active" id="profile">
                ...
                <div class="card-body pt-4 p-3 ">
                    <form action="/user-profile" method="POST" role="form text-left">
                        ...
                        <div class="d-flex justify-content-end">
                            <button type="submit" class="btn btn-info btn-md mt-4 mb-4">Save Changes</button>
                        </div>
                    </form>

                </div>
            </div>
            <div class="card tab-pane fade" id="password">
                <div class="card-header pb-0 px-3">
