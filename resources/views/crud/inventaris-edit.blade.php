                        ...
                        <form action="" class="container">
                            <div class="row">
                                ...
                                <div class="col-md-3 mb-2">
                                    ...
                                    <div class="input-group input-group-sm">
                                        <div class="input-group-text">{{ $invent->category->cat_code }}</div>
                                        <input type="text" class="form-control" value="{{ substr($invent->kode, 4) }}">
                                    </div>
                                </div>
                                <div class="col-md-3 mb-2">
                            ...
                            <div class="row">
                                <div class="col-md-3 mb-2">
                                    ...
                                    <input type="text" class="form-control form-control-sm" value="{{ $invent->merk }}">
                                </div>
                                <div class="col-md-3 mb-2">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 mb-2">
                                    ...
                                    <div class="input-group input-group-sm">
                                        ...
                                        <input type="text" class="form-control" value="{{ $invent->harga }}">
                                    </div>
                                </div>
                                <div class="col-md-3 mb-2">
